...
const TeacherCard: React.FC<TeacherCardProps> = ({
  ...
  return (
    <div className="group bg-white rounded-3xl border border-slate-200 p-3 pb-3 sm:p-6 md:p-6 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(8,112,184,0.12)] hover:-translate-y-2 relative overflow-hidden flex flex-col h-full">
      {alert && (
      ...
      <div className="p-2 bg-slate-100 rounded-2xl mb-6 grow">
        <div className="p-2 bg-slate-100 rounded-2xl mb-2 grow overflow-hidden">
          <p className="text-sm text-slate-600 leading-relaxed hyphens-auto text-justify italic min-h-[107px] wrap-break-word line-clamp-5">
