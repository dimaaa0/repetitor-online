...
const SubjectPicker = () => {
    ...
    const subjects = [
        ...
        "История", "География", "Обществознание", "Литература", "Информатика",
        "Английский язык", "Китайский язык", "Корейский язык", "Японский язык",
        "Арабский язык", "Немецкий язык", "Французский язык", "Испанский язык",
        "Итальянский язык", "Португальский язык", "Турецкий язык", "Греческий язык",
        "Экономика", "ОГП", "Шахматы", "Рисование"
    ];
