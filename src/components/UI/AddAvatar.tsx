...
import SubjectPicker from '../UI/SubjectPicker';
        ...
        <div className="flex items-start gap-6 flex-col sm:flex-row">
            <div className="relative group">
                ...
                <div
                    ...
                    className={`w-24 h-24 rounded-3xl flex flex-col items-center justify-center border-2 border-dashed transition-all cursor-pointer overflow-hidden
        ${previewUrl
