...
export default async function StudentProfilePage({
    ...
    const { data: adData, error: adError }: { data: adType | null; error: any } =
        await supabase.rpc("find_student_ad_by_short_id", { short_id: shortId }).single();
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-xl font-bold text-slate-800">Детали поиска</h3>
                        </div>
                    ...
                    <div className=" sticky top-24 bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
                        <div className="mb-6">
                            ...
                            <div className="flex items-baseline gap-2">
                                <span className="text-4xl font-black text-slate-800">{student.price}</span>
