        ...
        <main className="min-h-screen bg-[#f8fafc] pb-20">
            <div className="max-w-[1250px] relative mx-auto px-4 sm:px-6 pt-8">
               ...
               border-2 border-gray-200 p-1 bg-white"
                                        ...
                                        <div className="flex flex-wrap flex-column  flex-column flex-col justify-center md:justify-start items-center md:items-start gap-3">
                                            ...
                                            <div className="flex flex-wrap gap-3 sm:justify-start justify-center">
                                                <div className="flex items-center text-slate-500 bg-slate-50 px-4 py-2 rounded-full text-sm">
                                                    <MessageSquare className="w-4 h-4 mr-2" />30 отзывов
                                                </div>
                    ...
                    <div className="lg:col-span-4"> {/* Убрал space-y-6 отсюда, чтобы не мешал прилипанию */}
                ...
                <section className="bg-white lg:col-span-8 mt-6 rounded-3xl md:rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-sm space-y-8">
                    ...
                    <div className="bg-slate-50/100 p-4 md:p-6 rounded-[2rem] border border-slate-200">
                        <h3 className="text-sm font-bold text-slate-700 mb-4 px-1 uppercase tracking-wider">Оставить свой отзыв</h3>
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-end gap-4">
                                ...
                                <button className="w-full sm:w-auto px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-200 cursor-pointer">
                                    Отправить отзыв
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        {[1, 2, 3].map((item) => (
                            <div key={item} className="group sm:p-6 p-0 rounded-3xl bg-gray-50/50 hover:bg-white border border-transparent hover:border-slate-100 transition-all duration-300">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-900 hyphens-auto text-justify">Писаренко Дмитрий</h4>
                                            <p className="text-xs text-slate-400">12 мая 2024</p>
                                        </div>
                                    </div>
                                </div>
                                <p className="text-slate-600 hyphens-auto text-justify ">
                                    Чтобы органично вписать форму добавления
                                    комментария, лучше всего сделать её аккуратным текстовым полем
                                    в начале секции, которое «разворачивается» при клике, или отдельным
                                    блоком перед списком отзывов. Чтобы органично вписать форму
                                    добавления комментария, лучше всего сделать её аккуратным текстовым полем в начале секции, которое
                                    «разворачивается» при клике, или отдельным блоком перед списком отзывов. Чтобы органично вписать
                                    форму добавления комментария, лучше всего сделать её аккуратным текстовым полем в начале секции,
                                    которое «разворачивается» при клике, или отдельным блоком перед списком отзывов.
                                </p>
                            </div>
                        ))}
                    </div>
