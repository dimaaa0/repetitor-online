                        ...
                        <section className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div className="w-32 h-32 bg-blue-600 rounded-4xl shrink-0 flex items-center justify-center text-white text-4xl font-bold shadow-lg shadow-blue-200">
                                    {teacher?.profiles?.[0]?.avatar_url ? (
                                        <img
                                            src={teacher.profiles[0].avatar_url}
                                            alt="Avatar"
                                            className="w-full h-full object-cover rounded-4xl"
                                        />
                                    ) : (
                                        `${teacher?.profiles?.[0]?.name?.[0] || "?"}${teacher?.profiles?.[0]?.surname?.[0] || "?"}`
                                    )}
                                </div>
                                ...
                                <div className="grow">
                                    <div className="flex items-center gap-3 mb-2">
                                        <h1 className="text-3xl font-extrabold text-slate-900">
                                            {teacher?.profiles?.[0]?.name} {teacher?.profiles?.[0]?.surname}
                                        </h1>
